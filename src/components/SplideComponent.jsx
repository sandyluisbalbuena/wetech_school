...
export default function SplideComponent() {
	...
	const navs = [
		...
		["https://images.unsplash.com/photo-1610484826967-09c5720778c7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8b25saW5lJTIwZWR1Y2F0aW9ufGVufDB8fDB8fHww&auto=format&fit=crop&w=500&q=60","activites"],
				...
				<SplideSlide key={index} >
					<Link to={ '/'+nav[1] }>
						<div className='animate__animated animate__fadeIn  relative shadow-md shadow-secondary m-2 lg:m-5 bg-primary rounded-md hover:scale-105  transition-transform duration-200 px-5'>
							...
							<p className='me-2 text-4xl lg:text-8xl text-base-content uppercase absolute top-0 left-0 w-full h-full flex items-center justify-center'>{nav[1]}</p>
						</div>
					</Link>
				</SplideSlide>
			))}
